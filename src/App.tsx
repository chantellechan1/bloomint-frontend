                    ...
                    <div className={loading ? 'd-none' : ''}>
                        <Router>
                            <Routes>
                                ...
                                <Route path="*" element={<Login userToken={userToken} setUserToken={setUserToken} setLoading={setLoading} />} />
                                <Route path="/create_account" element={<CreateAccount setLoading={setLoading} />} />
                            </Routes>
                        </Router>
                    </div>
            }
